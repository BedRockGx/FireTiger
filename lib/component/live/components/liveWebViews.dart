...
<ul>
<ul><a href="https://www.jd.com/">京东</a></ul>
<ul><a href="https://www.taobao.com/">淘宝</a></ul>
</ul>
</body>
</html>
''';

class LiveWebViews extends StatefulWidget {
  var arguments;
  LiveWebViews(this.arguments);
  @override
  _LiveWebViewsState createState() => _LiveWebViewsState();
}

class _LiveWebViewsState extends State<LiveWebViews> {
  final Completer<WebViewController> _controller =
      Completer<WebViewController>();

  // String _url;

  // _LiveWebViewsState(this._url);
          ...
          Expanded(
            child: WebView(
              ...
              navigationDelegate: (NavigationRequest request) {
                if (request.url.startsWith('https://www.csdn.net/')) {
              ...
              onPressed: !webViewReady
                  ...
                  : () async {
                      if (await controller.canGoBack()) {
                        ...
                        Scaffold.of(context).showSnackBar(
                          const SnackBar(content: Text("您已经在首页了")),
                        );
                        return;
                      }
                    },
