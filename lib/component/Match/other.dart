...
class _OtherState extends State<Other> with TickerProviderStateMixin{

  TabController _tabController;

    List<Map> data = [
      {'day':'11/20', 'time':'00:00', 'title':'丁宁 VS 伊藤美诚', 'subtitle':'国际乓联卡塔尔公开赛-女单半决赛', 'status':1, 'bifen':'0:1', 'videoStatus':1},
      {'day':'11/20', 'time':'09:55', 'title':'赵大成/张玉珍vs马龙/高志远', 'subtitle':'LPL春季淘汰赛/BO3', 'status':1, 'bifen':'1:1', 'videoStatus':1},
